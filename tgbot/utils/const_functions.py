...
async def smart_send(bot: Bot, message: types.Message, user_id,message_thread=None, text_add=None, reply=None):
    ...
    if message.photo is not None:
        await bot.send_photo(chat_id=user_id,message_thread_id=message_thread,  photo=message.photo[-1].file_id, caption=get_text, reply_markup=reply)
    elif message.video is not None:
        await bot.send_video(chat_id=user_id,message_thread_id=message_thread, video=message.video.file_id, caption=get_text, reply_markup=reply)
    elif message.document is not None:
        await bot.send_document(chat_id=user_id, message_thread_id=message_thread,document=message.document.file_id, caption=get_text, reply_markup=reply)
    elif message.audio is not None:
        await bot.send_audio(chat_id=user_id,message_thread_id=message_thread, audio=message.audio.file_id, caption=get_text, reply_markup=reply)
    elif message.voice is not None:
        await bot.send_voice(chat_id=user_id,message_thread_id=message_thread, voice=message.voice.file_id, caption=get_text, reply_markup=reply)
    elif message.animation is not None:
        await bot.send_animation(chat_id=user_id, message_thread_id=message_thread,animation=message.animation.file_id, reply_markup=reply)
    elif message.sticker is not None:
        await bot.send_sticker(chat_id=user_id, message_thread_id=message_thread,sticker=message.sticker.file_id, reply_markup=reply)
    elif message.dice is not None:
        await bot.send_dice(chat_id=user_id,message_thread_id=message_thread, emoji=message.dice.emoji, reply_markup=reply)
    elif message.location is not None:
        await bot.send_location(chat_id=user_id, message_thread_id=message_thread,latitude=message.location.latitude, longitude=message.location.longitude,
                                reply_markup=reply)
    else:
        await bot.send_message(chat_id=user_id,message_thread_id=message_thread,text= get_text,reply_markup=reply)
