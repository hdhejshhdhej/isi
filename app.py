...
from tgbot.utils.misc_functions import autobackup, startup_notify, new_balance_linepay
...
async def scheduler_start(bot):
    ...
    scheduler.add_job(new_balance_linepay, "cron", minute='*/1', args=(bot,))  # Автобэкап в 00:00
